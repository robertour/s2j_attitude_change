...
models_energy <- list(
  sls_b1 = ivreg(spec_renewable_energy_germany_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b2 = ivreg(spec_funding_solar_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b3 = ivreg(spec_funding_wind_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b4 = ivreg(spec_investment_state_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b5 = ivreg(spec_prohibition_oilgas_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b6 = ivreg(spec_area_wind_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b7 = ivreg(spec_area_solar_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee)
)
...
models_energy_abs <- list(
  sls_b1 = ivreg(spec_renewable_energy_germany_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b2 = ivreg(spec_funding_solar_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b3 = ivreg(spec_funding_wind_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b4 = ivreg(spec_investment_state_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b5 = ivreg(spec_prohibition_oilgas_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b6 = ivreg(spec_area_wind_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee),
  sls_b7 = ivreg(spec_area_solar_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfee)
)
...
models_cannabis <- list(
  sls_b1 = ivreg(spec_recreational_use_legalisation_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b2 = ivreg(spec_purchase_restricted_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b3 = ivreg(spec_purchase_limit_recrational_use_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b4 = ivreg(spec_cultivation_cannabis_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b5 = ivreg(spec_cultivation_germany_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b6 = ivreg(spec_control_cultivation_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b7 = ivreg(spec_staterevenue_legalisation_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b8 = ivreg(spec_consumption_private_appartments_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b9 = ivreg(spec_protection_children_diff ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc)
)
...
models_cannabis_abs <- list(
  sls_b1 = ivreg(spec_recreational_use_legalisation_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b2 = ivreg(spec_purchase_restricted_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b3 = ivreg(spec_purchase_limit_recrational_use_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b4 = ivreg(spec_cultivation_cannabis_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b5 = ivreg(spec_cultivation_germany_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b6 = ivreg(spec_control_cultivation_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b7 = ivreg(spec_staterevenue_legalisation_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b8 = ivreg(spec_consumption_private_appartments_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc),
  sls_b9 = ivreg(spec_protection_children_diff_abs ~ url_int_visits_yn + age + gender_f + edu_time + search_internet_pre | group_f + age + gender_f + edu_time + search_internet_pre, data = dfc)
)
